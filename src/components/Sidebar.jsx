...
export default function Sidebar({ view, setView, empresas, contratos, theme, onToggleTheme, currentUser, isSuperAdmin, onLogout, profile }) {
  ...
  const navAdmin = [
    { id: 'logs',          label: 'Logs de Atividade', icon: IconFileText },
  ...
  return (
    <aside style={S.sidebar}>
      ...
      <div style={S.logo}>
        ...
        <div style={{ fontSize: 11, color: '#475569', marginTop: 2 }}>José Justo</div>
      </div>
      ...
      <nav style={S.nav}>
        ...
        {/* Admin section — always shown, content gated in each view */}
        <div style={S.section}>
        ...
        {currentUser && (
          <button
            ...
            style={{
              ...
              background: view === 'perfil' ? '#1E293B' : '#0F172A',
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          <button
            ...
            style={{
              ...
              padding: '7px 0', borderRadius: 5, border: '1px solid #1E293B',
              background: 'transparent', color: '#475569', fontSize: 11, cursor: 'pointer',
            }}
          >
            {theme === 'light'
              ? <><IconMoon size={12} color="#475569" /> Escuro</>
              : <><IconSun  size={12} color="#475569" /> Claro</>
            }
          </button>
          {onLogout && (
            <button
